...
<body class="login-page bg-body-secondary">
    <div class="login-box" >
        <div class="login-logo"> <a href="../index2.html"><b >Welcome Back</b></a> </div> <!-- /.login-logo -->
        <div class="card"  style="border-radius: 15px; background-color: #f1f1f1; padding: 20px;">
            <div class="card-body login-card-body" style="border-radius: 15px; background-color: #f1f1f1; padding: 20px;">
                ...
                <p class="mb-1"> <a href="forgot-password.html" style="text-decoration: none;">I forgot my password</a> </p>
